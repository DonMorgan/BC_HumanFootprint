...
habitat. The layers are assigned resistance and source weights after
McRae et al 2016
...
This project is part of a Provincial scale conservation assessment the analysis
is exploratory.
...
Roads are rasterized at 300m and assumes that the ‘footprint’ of a road
extends 150m on either side of the mid line. Potential modifications
...
To report bugs/issues/feature requests, please file an [issue](https://github.com/DonMorgan/BC_HumanFootprint/issues/).
...
This repository is maintained by [Don Morgan](https://github.com/DonMorgan). 
